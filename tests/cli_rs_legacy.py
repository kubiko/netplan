...
exe_cli = [os.path.join(rootdir, 'netplan-cli-rs', 'target', 'release', 'netplan')]
...
@unittest.skip('argument format specific to Python CLI (clap output differs)')
...
''')
        ...
        self.assertIn("'netplan try' is restoring configuration", res.stderr)
